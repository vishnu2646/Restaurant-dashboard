...
const RestaurentCard: React.FC<RestaurentCardProps> = ({ restaurant, isLoading }) => {
    return (
        <>
            <RestaurantSkeleton isLoading={isLoading}>
                    ...
                    <Card className='w-auto shadow-sm'>
                        ...
                        <CardContent>
                            <div className='flex items-center justify-between my-3 sm:flex-nowrap flex-wrap'>
                                <h2 className='truncate'>{restaurant.name}</h2>
                            ...
                            <div>
                                <div className='flex items-center gap-2 mb-3'>
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger className='text-left truncate w-[100px] lg:w-[150px]'>
                                            <span className='text-sm text-input font-light truncate'>{restaurant.address}</span>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            {restaurant.address}
                                        </TooltipContent>
                                ...
                                <div className='flex items-center gap-2'>
                                    ...
                                    <span className='text-sm text-input font-light sm:truncate w-[100px]'>{restaurant.empCount} Employees</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
